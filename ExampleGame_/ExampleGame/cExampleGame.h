...
namespace eae6320
{
	...
	private:
		...
		//Akshay: Added this line to make changes 
		...
		virtual const char* GetMainWindowClassName() const override { return "Yewale-Akshay Main Window Class"; }
	...
	//	void SubmitDataToBeRendered(const float i_elapsedSecondCount_systemTime, const float i_elapsedSecondCount_sinceLastSimulationUpdate,
	//			eae6320_001::Graphics::sColor &i_clearColor);
